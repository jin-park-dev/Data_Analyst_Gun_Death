...
"""
Investigating gun suicide and month.
"""


def display_info_by(col, intent_filter):

    gun_data_filtered = gun_data[gun_data['intent'] == intent_filter]
    ...
    count_by_col['x_label'] = count_by_col['x_label'].dt.year.astype(str) + '-' + count_by_col['x_label'].dt.month.astype(str)
